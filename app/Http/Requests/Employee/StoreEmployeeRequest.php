...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules() : array
    {
        return [
            ...
            'ktp_number' => ['required', 'digits:16', Rule::unique('employees', 'ktp_number'),],
            'kk_number' => ['nullable', 'digits:16', Rule::unique('employees', 'kk_number'),],
            ...
            'zipcode_ktp' => 'required|string|max:10',
