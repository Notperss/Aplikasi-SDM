...
<div id="modal-form-add-educational-history" class="modal fade" tabindex="-1"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form action="{{ route('employeeEducationalHistory.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-md-12"> <!-- Make form smaller with col-md-6 and center it -->
              ...
              <div class="row">
                <div class="col-md-6 mb-2">
                  <label class="form-label" for="year_from">Tahun Masuk <code>*</code></label>
