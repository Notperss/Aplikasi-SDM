<!-- Modals add menu -->
<div id="modal-form-edit-training-certificate-{{ $employeeTrainingAttended->id }}" class="modal fade"
  aria-labelledby="modal-form-edit-training-certificate-{{ $employeeTrainingAttended->id }}-label" aria-hidden="true">
    ...
    <div class="modal-content">
      <form action="{{ route('employeeTrainingAttended.update', $employeeTrainingAttended) }}" method="post"
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="modal-form-edit-training-certificate-{{ $employeeTrainingAttended->id }}-label">
