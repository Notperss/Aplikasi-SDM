<!-- Modals add menu -->
<div id="modal-form-add-award" class="modal fade" tabindex="-1" aria-labelledby="modal-form-add-award-label"
  aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form action="{{ route('employeeAward.store') }}" method="post" enctype="multipart/form-data">
        @csrf

        <div class="modal-header">
          <h5 class="modal-title" id="modal-form-add-award-label">Tambah Data AWARD</h5>
          ...
          <div class="row justify-content-center">
            <div class="col-md-12"> <!-- Make form smaller with col-md-6 and center it -->
              ...
              <div class="col-12 mb-2">
                ...
                <input id="name_award" type="text" name="name_award" value="{{ old('name_award') }}"
              ...
              <div class="col-12 mb-2">
                ...
                <input id="date_award" type="date" name="date_award" value="{{ old('date_award') }}"
              ...
              <div class="mb-2">
                <label for="file_award" class="form-label">File Award</label>
