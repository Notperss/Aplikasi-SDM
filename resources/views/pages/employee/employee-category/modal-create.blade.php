<!-- Modals add menu -->
<div id="modal-form-add-employeeCategory" class="modal fade" tabindex="-1"
  aria-labelledby="modal-form-add-employeeCategory-label" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form action="{{ route('employeeCategory.store') }}" method="post" enctype="multipart/form-data">
        @csrf

        <div class="modal-header">
          <h5 class="modal-title" id="modal-form-add-employeeCategory-label">Tambah Kategori Karyawan</h5>
