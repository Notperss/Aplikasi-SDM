...
<div id="modal-form-add-duty" class="modal fade" tabindex="-1" aria-labelledby="modal-form-add-duty-label"
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <form id="selectedEmployeesForm" action="{{ route('employeeDuty.store') }}" method="post"
        enctype="multipart/form-data">
        @csrf

        <div class="modal-header">
          <h5 class="modal-title" id="modal-form-add-duty-label">Tambah Data Seminar/Pelatihan</h5>
