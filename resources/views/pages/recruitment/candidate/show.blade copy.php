          ...
          <div class="row">
            ...
            <div class="col-md-6 col-12">
              ...
              <div class="form-group">
                ...
                <input type="text" inputmode="numeric" value="{{ old('npwp_number', $candidate->applied_position) }}"
                  id="npwp_number" class="form-control @error('npwp_number') is-invalid @enderror" name="npwp_number"
                  readonly>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6 col-12">
              ...
              <div class="form-group">
                ...
                <input type="text" value="{{ old('candidate_from', $candidate->candidate_from) }}" id="candidate_from"
                  class="form-control @error('candidate_from') is-invalid @enderror" name="candidate_from" readonly>
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" id="latitude_ktp" value="{{ $candidate->latitude_ktp }}" class="form-control"
                    readonly>
                </div>
                <div class="form-group col-md-6">
                  <label for="longitude_ktp">Longitude Alamat KTP</label>
                  <input type="text" id="longitude_ktp" value="{{ $candidate->longitude_ktp }}" class="form-control"
                    readonly>
                </div>
              </div>
              <div class="form-group">
                ...
                <textarea type="text" id="current_address"
                  class="form-control @error('current_address') is-invalid @enderror" name="current_address" rows="5"
                  readonly> {{ old('current_address', $candidate->current_address) }}</textarea>
              </div>
              <div class="row">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-bold-500 text-center">
                      ...
                      <a href="{{ Storage::url($educationalHistory->file_ijazah) }}" target="_blank" class="text-sm">
                        Lihat
                      </a>
                      @else
                      <span>-</span>
