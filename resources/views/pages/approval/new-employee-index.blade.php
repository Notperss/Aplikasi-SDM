...
@section('breadcrumb')
  <x-breadcrumb title="Karyawan Baru" page="Karyawan Baru" active="Persetujuan" route="{{ route('approval.index') }}" />
@endsection
  ...
  <div class="card">
    <div class="card-header">
      <div class="d-flex justify-content-between align-items-center ">
        <h5 class="fw-normal mb-0 text-body">Daftar Karyawan Baru</h5>
  ...
  <script>
    jQuery(document).ready(function($) {
      $('#table-approval').DataTable({
        ...
        ajax: {
          url: "{{ route('approval.newEmployeeIndex') }}",
        },
        columns: [{
            data: 'DT_RowIndex',
            name: 'DT_RowIndex',
