...
@section('breadcrumb')
  <x-breadcrumb title="Edit Kontrak" page="Persetujuan" active="Edit" route="{{ route('approval.index') }}" />
@endsection
              ...
              <div class="col-md-6">
                <div class="my-2">
                  ...
                  @php
                    ...
                    $status = '<span class="badge bg-primary mb-1">' . $approval->description . '</span>';
