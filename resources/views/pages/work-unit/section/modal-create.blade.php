<!-- Modals add menu -->
<div id="modal-form-add-section" class="modal fade" tabindex="-1" aria-labelledby="modal-form-add-section-label"
    ...
    <div class="modal-content">
      <form action="{{ route('section.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="modal-form-add-section-label">Tambah Divisi</h5>
